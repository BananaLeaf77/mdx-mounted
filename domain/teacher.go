...
type TeacherUseCase interface {
	...
	GetAllBookedClass(ctx context.Context, uuid string, f PaginationFilter) (*[]Booking, error)
	...
	GetMyClassHistory(ctx context.Context, teacherUUID string, f PaginationFilter) (*[]ClassHistory, error)
